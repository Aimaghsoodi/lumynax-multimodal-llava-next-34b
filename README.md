...
[🤗 Weights & model card on Hugging Face](https://huggingface.co/AbteeXAILab/lumynax-multimodal-llava-next-34b) · [abteex.com](https://abteex.com) · [lumynax.com](https://lumynax.com) · [Monorepo](https://github.com/Aimaghsoodi/lumynax-release)

---

This GitHub repo mirrors the **runtime scaffolding** (quickstart, requirements, Modelfile, Space, docs). The model **weights** are published on Hugging Face at `AbteeXAILab/lumynax-multimodal-llava-next-34b` — they exceed GitHub's per-file limit.

```bash
hf download AbteeXAILab/lumynax-multimodal-llava-next-34b --local-dir lumynax-multimodal-llava-next-34b
cd lumynax-multimodal-llava-next-34b && pip install -r requirements.txt && python quickstart.py --interactive
# Or:  pip install lumynax && lumynax run lumynax-multimodal-llava-next-34b -i
```
